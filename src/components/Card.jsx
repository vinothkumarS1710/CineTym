...
const Card = ({movie}) => {
  ...
  return (
    <div className="bg-neutral-primary-soft mx-auto block max-w-xs p-6 m-6 border border-black hover:border-[#FF4B33] hover:border-2 rounded-2xl cursor-pointer transition-all duration-300 ease-in-out hover:scale-105" onClick={goToMovie}>
